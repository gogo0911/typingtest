...
function typing(){
    ...
    // 배열안에 있는 한단어씩 제거해서 출력
        ...
        subText.innerText = backTextList[subIndex].substr(0,maxIndex);
        maxIndex--;//1씩 감소
        if(maxIndex < 0){ //한문장의 글자제거가 전부 끝나면
            backIndex = 0; //다음문장의 첫번째 글자서부터 출력을 하기 위해 초기화
